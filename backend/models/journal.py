...
class JournalEntry(Base):
    ...
    bank_statement_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey('bank_statement.id'))
    ...
    reconciliation_match: Mapped[ReconciliationMatch | None] = relationship(back_populates='journal_entries')
    bank_statement: Mapped[BankStatement | None] = relationship(back_populates='journal_entries')
    remittance_advice_line: Mapped[RemittanceAdviceLine | None] = relationship(back_populates='journal_entries')
