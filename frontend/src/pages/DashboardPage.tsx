...
export default function DashboardPage() {
    ...
    const stats = useMemo(() => {
        ...
        const review = items.matches.filter((m) =>
            ['MANUAL_REVIEW', 'UNMATCHED'].includes(m.status),
        ).length
        ...
        <Container sx={{ py: 3 }}>
            ...
            <Paper sx={{ p: 3, mb: 3 }}>
                ...
                <Stack direction={{ xs: 'column', md: 'row' }} spacing={2}>
                    ...
                    />
                    <Button variant="contained" onClick={ingest} sx={{ minWidth: 160 }}>
                        Run Ingestion
                    </Button>
                </Stack>
                {error ? (
            ...
            {stats ? (
                <Grid container spacing={2} sx={{ mb: 3 }}>
                    {[
                        ...
                        ['Auto Matched', stats.auto],
                        ['Partial Match', stats.partial],
